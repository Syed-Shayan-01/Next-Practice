    ...
    <>
      <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <Link href="/">
          <img
            class="mx-auto hover:cursor-pointer h-18 w-auto"
            src="/picture/saylani.png"
            alt="Your Company"
            />
            </Link>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" action="#" method="POST">
           ...
           ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset
            ...
            <div>
              <button
                type="submit"
                class="flex w-full justify-center rounded-md bg-green-600
         px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500
          ...
          <p class="mt-10  text-center text-sm text-gray-500">
            ...
            <Link
              href="./signup"
              class="font-semibold ml-1 leading-6 text-green-600 hover:text-green-500"
            >
              Sign up
            </Link>
          </p>
